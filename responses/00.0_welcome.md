...
1. Navigate to Travis CI's sign in page in a separate tab.
1. Sign in with GitHub and set up a build on Travis CI for this repository. You will need to add this project, and 'start building'.
    - You can find step by step instructions in Travis CI's documentation.
